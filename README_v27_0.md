...
This README replaces the Release 1.1 file map.
...
Project and canon documents are in English. Chat discussion may be in Swedish.

Preserved in-world exceptions:

- Ederhamn / Elvestad / Ederstad;
- Whitehart's liturgical phrase **Icke jag**.
...
The following remain useful history but are not current authority:
...
- lore-bible versions before v27.0

Do not merge old material back into current files. A desired old detail must pass through the current gate process.
...
5. Obtain author approval for a canon change.
6. Update the Lore Bible, changelog, affected support files, and prose.
7. Build a fresh release manifest with hashes.
8. Archive older releases; do not silently merge them.

---

# CURRENT PRODUCTION STAGE

Book One is ready for:

1. external beta reading;
2. feedback triage against canon and voice;
3. human proof / typesetting proof;
4. cover-copy correction and final visual package;
5. Book Two house gate after beta findings and Garron-succession review.
